...
public class Matrix {
  ...
  /**
   * Create a 4x4 homogenious rotation matrix for OpenGL usage (transposed to regular version).
   */
  ...
  /**
   * Create 4x4 homogenious translation for OpenGL usage (transposed to regular version).
   */
